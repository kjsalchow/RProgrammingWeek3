## Write a function called rankhospital that takes three arguments: the 2-
## character abbreviated name of a state (state), an outcome (outcome), and the 
...
## \best", \worst", or an integer indicating the ranking (smaller numbers are 
## better). If the number given by num is larger than the number of hospitals 
## in that state, then the function should return NA. Hospitals that do not 
...
## value is passed to best, theunction should throw an error via the stop 
## function with the exact message \invalid state. If an invalidoutcome value 
